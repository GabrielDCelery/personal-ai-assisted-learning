...
Concept: context.Context is Go's standard way to handle cancellation, deadlines, and request-scoped values. It's preferred over done channels in production code.
...
Key learning: Context is the idiomatic way to handle cancellation in Go APIs - you'll see it as the first parameter in most library functions.
