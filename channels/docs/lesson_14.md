...
Concept: Use a buffered channel as a counting semaphore to limit concurrent operations. This prevents overwhelming resources (APIs, databases, file
system).
...
Key learning: Buffered channels as semaphores is idiomatic Go - no need for external libraries. This pattern is essential for rate-limiting concurrent
