...
Concept: Using select with time.After() lets you set deadlines on channel operations, preventing your program from waiting forever.
...
Key learning: This pattern is essential for network calls, database queries, or any operation that might hang.
