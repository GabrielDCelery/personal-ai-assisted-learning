...
Concept: A "done" channel signals goroutines to stop working. This is how you gracefully shut down concurrent operations.
...
Key learning: This pattern is the foundation of Go's context.Context cancellation.

## select works with both sends and receives
