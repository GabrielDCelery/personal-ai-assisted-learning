...
Concept: A WaitGroup waits for a collection of goroutines to finish. This solves the "how do I know when all workers are done?" problem properly.
...
Key learning: WaitGroup is essential for coordinating goroutine completion, especially when you don't know how many items will be processed.

## how does job := range jobs work
